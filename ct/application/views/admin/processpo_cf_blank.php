...
<?php //echo json_encode($arrod); ?>
  ...
  <table border="0" class="div-edit-litsec">
    ...
    <tr>
      <td style="width:305px;text-align:right;font-size:14px;">紙材採購單</td>
      <td style="width:200px;text-align:right;font-size:10px;">日期：<?php echo $arrod[0]['podate']; ?></td>
    </tr>
  </table>
  <table border="0" class="div-edit-litsec">
    <tr><td width="100">&nbsp;工單號碼</td><td width="115">&nbsp;紙材</td><td width="115">&nbsp;尺寸</td><td width="115">&nbsp;數量</td><td width="104">&nbsp;指送</td></tr>	
  </table>
