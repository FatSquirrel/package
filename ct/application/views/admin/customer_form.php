...
<?php
		...
		if( $mode === 'EDIT' ) :   
			...
			echo form_fieldset("客戶編輯表單");
			
			echo form_hidden("hd_id",$editing_row['id']);
			?>
    	<div class="control-group" style="display:none;">
				<label class="control-label">客戶系統編號</label>
				<div class="controls">
    	...
    	<div class="control-group">
		<label class="control-label" for='txt_payremark'>結帳日</label>
		<div class="controls">			
